...
for iterr = 1
    ...
    for k = 4
        ...
        for fn = 1 : size( flist, 1 )
            ...
            vars = struct;
            vars.N_inputs = [ size( data0, 1 ) ];% numbers of input units, (1) X (N), where N represent the number of modality.
            ...
            [ vars, act ] = HSM_process_GPU( vars, [ data0 ] );
            ...
            for beh = 1 : 4
                for iter = 1 : 30
                    ...
                    acc = idx_out == idx_Te;
                    acc_HSM( beh, iter ) = mean( acc, 1, 'omitnan' );
                end; clear iter
            end; clear beh
            ...
            save( [ 'Results_ExpRD', fname( 8 : end - 4 ), '_k', num2str( k ), '_iterr', num2str( iterr ), '.mat' ], 'acc_HSM' )
