...
% exp_group = 1;
% 
% mm_acc_data = squeeze( mean( mm_acc_data( :, 1, exp_group, : ), 1, 'omitnan' ) );
% % AG
% mm_acc_act_G = squeeze( mean( mm_acc_act_G( :, 1, exp_group, : ), 1, 'omitnan' ) );
% mm_acc_rec_G = squeeze( mean( mm_acc_rec_G( :, 1, exp_group, : ), 1, 'omitnan' ) );
% % HSM
% mm_acc_HSM = squeeze( mean( mm_acc_HSM( :, 1, exp_group, : ), 1, 'omitnan' ) );
% % AG -> HSM
% mm_acc_HSM_G = squeeze( mean( mm_acc_data( :, 1, exp_group, : ), 1, 'omitnan' ) );
% mm_acc_HSM_recG = squeeze( mean( mm_acc_data( :, 1, exp_group, : ), 1, 'omitnan' ) );
% % HSM -> AG
% mm_acc_act_G_HSM = squeeze( mean( mm_acc_act_G_HSM( :, 1, exp_group, : ), 1, 'omitnan' ) );
% mm_acc_rec_G_HSM = squeeze( mean( mm_acc_rec_G_HSM( :, 1, exp_group, : ), 1, 'omitnan' ) );
% 
% mmm_acc_data = mean( mm_acc_data, 1, 'omitnan' );
% smm_acc_data = std( mm_acc_data, 0, 1, 'omitnan' );
% % AG
% mmm_acc_act_G = mean( mm_acc_act_G, 1, 'omitnan' );
% smm_acc_act_G = std( mm_acc_act_G, 0, 1, 'omitnan' );
% mmm_acc_rec_G = mean( mm_acc_rec_G, 1, 'omitnan' );
% smm_acc_rec_G = std( mm_acc_rec_G, 0, 1, 'omitnan' );
% % HSM
% mmm_acc_HSM = mean( mm_acc_HSM, 1, 'omitnan' );
% smm_acc_HSM = std( mm_acc_HSM, 0, 1, 'omitnan' );
% % AG -> HSM
% mmm_acc_HSM_G = mean( mm_acc_HSM_G, 1, 'omitnan' );
% smm_acc_HSM_G = std( mm_acc_HSM_G, 0, 1, 'omitnan' );
% mmm_acc_HSM_recG = mean( mm_acc_HSM_recG, 1, 'omitnan' );
% smm_acc_HSM_recG = std( mm_acc_HSM_recG, 0, 1, 'omitnan' );
% % HSM -> AG
% mmm_acc_act_G_HSM = mean( mm_acc_act_G_HSM, 1, 'omitnan' );
% smm_acc_act_G_HSM = std( mm_acc_act_G_HSM, 0, 1, 'omitnan' );
% mmm_acc_rec_G_HSM = mean( mm_acc_rec_G_HSM, 1, 'omitnan' );
% smm_acc_rec_G_HSM = std( mm_acc_rec_G_HSM, 0, 1, 'omitnan' );
% 
% disp( [ 'Dataset: ', dataset_name ] )
% disp( [ 'Data: ', num2str( mmm_acc_data ) ] )
% disp( [ 'AG: ', num2str( mmm_acc_act_G ) ] )
% % disp( [ 'AG rec.: ', num2str( mmm_acc_rec_G ) ] )
% disp( [ 'HSM: ', num2str( mmm_acc_HSM ) ] )
% disp( [ 'AG -> HSM: ', num2str( mmm_acc_HSM_G ) ] )
% % disp( [ 'AG -> HSM rec.: ', num2str( mmm_acc_HSM_recG ) ] )
% disp( [ 'HSM -> AG: ', num2str( mmm_acc_act_G_HSM ) ] )
% % disp( [ 'HSM -> AG rec.: ', num2str( mmm_acc_rec_G_HSM ) ] )
% 
% disp( [ 'Dataset: ', dataset_name ] )
% disp( [ 'Data: ', num2str( smm_acc_data ) ] )
% disp( [ 'AG: ', num2str( smm_acc_act_G ) ] )
% % disp( [ 'AG rec.: ', num2str( smm_acc_rec_G ) ] )
% disp( [ 'HSM: ', num2str( smm_acc_HSM ) ] )
% disp( [ 'AG -> HSM: ', num2str( smm_acc_HSM_G ) ] )
% % disp( [ 'AG -> HSM rec.: ', num2str( smm_acc_HSM_recG ) ] )
% disp( [ 'HSM -> AG: ', num2str( smm_acc_act_G_HSM ) ] )
% % disp( [ 'HSM -> AG rec.: ', num2str( smm_acc_rec_G_HSM ) ] )
% 
% pVal = signrank( mm_acc_act_G, mm_acc_HSM, 'tail', 'both' );
% disp( [ 'p = ', num2str( pVal ) ] )
% 
